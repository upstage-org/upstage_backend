#!/bin/bash
# In-container wrapper for the event_archive service. Activates the
# editable-installed venv and hands off to the `scripts.run_event_archive`
# module entry point.
#
...
# `scripts.run_event_archive` (and `scripts/__init__.py`) resolve.
set -e
cd /usr/app
